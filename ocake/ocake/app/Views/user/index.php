             ...
             <div class="col-lg-8 col-12 custom-padding-right">
                 <div class="slider-head">
                     ...
                     <div class="hero-slider">
                         <!-- Start Single Slider -->
                         <!-- <div class="single-slider" style="background-image: url(assets/images/hero/slider-bg1.png);">
                             <div class="content">
                 ...
                 <div class="single-product">
                     <div class="product-image">
                         ...
                         <form action="<?=site_url('add_cart')?>" method="POST">
                                                    <input type="id" name="uid" value="<?=session('email')?>">
     ...
     <div class="container">
         <div class="row">
             <div class="col-lg-6 col-md-6 col-12">
                 <div class="single-banner" style="background-image:url('assets/images/banner/banner-1-bg.png')">
                     <div class="content">
             ...
             <div class="col-lg-6 col-md-6 col-12">
                 <div class="single-banner custom-responsive-margin"
                     style="background-image:url('assets/images/banner/banner-2-bg.png')">
                     <div class="content">
                         <h2>New Year Cake</h2>
