                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            ...
                                            <div class="form-input form">
                                                <input type="text" placeholder="Email Address" name="email_add">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="single-form form-default">
                                            ...
                                            <div class="select-items">
                                                <select name="payment_method" class="form-control">
                                                    ...
                                                    <option value="COD">Pickup on Demand Delivery</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            ...
                                            <div class="form-input form">
                                                <input type="text" placeholder="Delivery/Pick-up Date" name="delivery_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="checkout-sidebar-price-table mt-30">
                        ...
                        <div class="total-payable">
                            <div class="payable-price">
                                ...
                                <p class="price"><?php echo '&#8369;'. number_format($Total); ?></p>
                            </div>
                        </div>
