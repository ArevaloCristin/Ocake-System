                                    ...
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <input type="text" placeholder="First Name" name=" firstname" 
                                                            <?php foreach($userData as $data){?> value="<?php echo $data->firstname;?>"<?php }?>>  
                                                    </div>
                                                    <div class="col-md-6 form-input form">
                                                        <input type="text" placeholder="Last Name" name="lastname" 
                                                            <?php foreach($userData as $data){?> value="<?php echo $data->lastname;?>"<?php }?>>  
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="text" placeholder="Email Address" name="email" 
                                                        <?php foreach($userData as $data){?> value="<?php echo $data->email;?>"<?php }?>>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="datetime-local" placeholder="Delivery/Pick-up Date" name="date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <select type="delivery_method" id="delivery_method" name="delivery_method" class="form-control">
                                                        <option value="" disabled selected>select</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <select type="payment_method" id="payment_method" name="payment_method" class="form-control">
                                                        <option value="" disabled selected>select</option>
                        ...
                        <div class="checkout-sidebar-price-table">
                            ...
                            <div class="total-payable">
                                ...
                                <div class="payable-price">
                                    ...
                                    <p class="price" name="shipping_fee"><?//php echo '&#8369;'. number_format($Total); ?></p>
                                </div>
                                <div class="payable-price">
                                    <p class="value">Price to Pay:</p>
                                    <p class="price" name="price"><?//php echo '&#8369;'. number_format($Total); ?></p>
                                </div>
                            </div>
