...
<div class="btn-group mt-3 " style="margin-left:8%">
  ...
  <a href="<?=site_url('cancelledorder')?>" class="btn btn-primary" role="button" style="background-color:#d10f94; border-color:#d10f94">Cancelled</a>
</div>

<div class="mt-5 mb-5">
    <div class="container">
        <div class="cart-list-head">
            <div class="p-3 text-center text-white text-lg  rounded-top" style="background-color:#d10f94"><span class="text-uppercase">Cancelled Orders </span></div>
