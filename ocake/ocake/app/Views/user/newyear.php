                                        ...
                                        <ul class=" shopping-list">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="remove" title="Remove this item"><i
                                                        class="lni lni-close"></i></a>
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="p<?=site_url('productgrid')?>"><img
                                                            src="assets/images/header/cart-items/item2.jpg" alt="#"></a>
                                                </div>
                                                <div class="content">
                                                    <h4><a href="<?=site_url('productgrid')?>">Wi-Fi Smart Camera</a>
                                                    </h4>
                    ...
                    <div class="nav-inner">
                        ...
                        <div class="mega-category-menu">
                            ...
                            <ul class="sub-category">
                                <li><a href="<?=site_url('productgrid')?>">Occasions <i
                                            class="lni lni-chevron-right"></i></a>
                                    <ul class="inner-sub-category">
                                        <li><a href="<?=site_url('birthday')?>">Birthday</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Christening</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Wedding</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Graduation</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Valentine</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Halloween</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">Christmas</a></li>
                                        <li><a href="<?=site_url('productgrid')?>">New Year</a></li>

                                        <!--<li><a href="product-grids.html">Batteries</a></li>
                                    <li><a href="product-grids.html">Cables & Adapters</a></li>-->
                                    </ul>
                                </li>
                                <li><a href="<?=site_url('productgrid')?>">Popular Cakes</a></li>
                                <li><a href="<?=site_url('productgrid')?>">New Arrival</a></li>
                                <li><a href="<?=site_url('productgrid')?>">Miscellaneous</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">New Year Page</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="http://localhost/ocake/public/uploads/<?php echo $data->image;?>"
                                                    alt="#">
                                                <div class="button">
